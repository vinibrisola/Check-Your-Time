...
const Clientes = () => {
  ...
  const { clientes, form, behavior, components,cliente } = useSelector((state) => state.cliente);
    ...
    <div className="col p-5 overflow-auto h-100">
      <Drawer show={components.drawer} size="sm" onHide={() => setComponent('drawer', false)}>
        <Drawer.Body>
          ...
          <div className="row mt-3">
            <div className="form-group mb-3">
              ...
              {behavior === 'create' && (<div className="input-group-append">
                  <Button appearance="primary" loading={form.filtering} disabled={form.loading} onClick={()=> dispatch(filterClientes())}>Pesquisar</Button>
              </div>
              )}
              </div>
            </div>
            ...
            <div className="form-group col-6">
              ...
              <select
                ...
                onChange={(e) => setCliente('documento',{...cliente.documento,tipo: e.target.value,})}
              >
            ...
            <div className="form-group col-3">
              ...
              <input
                ...
                onChange={(e) => setCliente('endereco',{...cliente.endereco, cep: e.target.value,})}
              />
            </div>
            <div className="form-group col-6">
              ...
              <input
                ...
                onChange={(e) => setCliente('endereco',{...cliente.endereco, logradouro: e.target.value,})}
              />
            </div>
            <div className="form-group col-3">
              <b className="">UF</b>
              <input
                ...
                onChange={(e) => setCliente('endereco',{...cliente.endereco, uf: e.target.value,})}
              />
            </div>
            <div className="form-group col-9">
              ...
              <input
                ...
                onChange={(e) => setCliente('endereco',{...cliente.endereco, cidade: e.target.value,})}
              />
            </div>
          </div>
          <Button
          ...
          >
            {behavior === "create" ? 'Salvar' : 'Remover'} Cliente</Button>
        </Drawer.Body>
      </Drawer>
